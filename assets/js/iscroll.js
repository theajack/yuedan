...
function hidePullUp(){
  var y=getMoveY();
  $("#scroller").css("transform","translate(0px,"+(y+71)+"px)");
}
function getMoveY(){
  var ts=$("#scroller").css("transform").split(",");
  var y=ts[ts.length-1];
  return parseInt(y.substring(1,y.length-1));
}
/**
 * 初始化iScroll控件
 */
